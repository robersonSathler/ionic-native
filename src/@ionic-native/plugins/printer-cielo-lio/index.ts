 ...
 * @usage
 * ```typescript
 * import { Printer, PrintOptions } from '@ionic-native/printer-cielo-lio/ngx';
 *
...
@Plugin({
  pluginName: 'Printer',
  plugin: 'cordova-plugin-printer-cielo-lio',
  pluginRef: 'cordova.plugins.printer.cielo.lio',
  repo: 'https://github.com/robersonSathler/cordova-plugin-printer',
  platforms: ['Android']
})
@Injectable()
